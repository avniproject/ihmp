...
create or replace view ihmp_rti_services_view as
  (SELECT individual.uuid                                                                        "Ind.uuid",
          ...
          extract(years from age(individual.date_of_birth))                                      "Ind.age",
    ...
    (
        ...
        SELECT individual.uuid                                                                                         "Ind.uuid",
               ...
               get_coded_string_value(
                           individual.observations -> '1eb73895-ddba-4ddb-992c-03225f93775c',
                           concepts.map)::TEXT                                                                          as "Ind.Whether any disability",
               individual.observations ->>
               '43c4860f-fccf-48c9-818a-191bc0f8d0cf'::TEXT                                                         as "Ind.Aadhaar ID",
               get_coded_string_value(
                           individual.observations -> 'c922c13c-1fa2-42dd-a7e8-d234b0324870',
                           concepts.map)::TEXT                                                                          as "Ind.Religion",
               get_coded_string_value(
                           individual.observations -> '6617408e-b89e-4f2f-ab10-d818c5d7f1bd',
                           concepts.map)::TEXT                                                                          as "Ind.Status of the individual",
               individual.observations ->>
               'f27e9504-81a3-48d9-b7cc-4bc90dbd4a30'::TEXT                                                         as "Ind.Disability",
               get_coded_string_value(
                           individual.observations -> '1b6ae290-1823-4aab-91a5-b1d8a1b3b837',
                           concepts.map)::TEXT                                                                          as "Ind.Relation to head of the family",
               individual.observations ->>
               '82fa0dbb-92f9-4ec2-9263-49054e64d909'::TEXT                                                         as "Ind.Contact Number",
               get_coded_string_value(
                           individual.observations -> '61ab6413-5c6a-4512-ab6e-7d5cd1439569',
                           concepts.map)::TEXT                                                                          as "Ind.Caste Category",
               get_coded_string_value(
                           individual.observations -> '92475d77-7cdd-4976-98f0-3847939a95d1',
                           concepts.map)::TEXT                                                                          as "Ind.Whether sterilized",
               get_coded_string_value(
                           individual.observations -> 'cd83afec-d147-42b2-bd50-0ca460dbd55f',
                           concepts.map)::TEXT                                                                          as "Ind.Occupation",
               get_coded_string_value(
                           individual.observations -> '476a0b71-485b-4a0a-ba6f-4f3cf13568ca',
                           concepts.map)::TEXT                                                                          as "Ind.Ration Card",
               get_coded_string_value(
                           individual.observations -> 'aa6687c9-ba4d-49a3-9b3e-bba266eb6f32',
               ...
               '92b08af5-84f7-4f8a-b8ac-90609fa58db7'::TEXT                                                         as "Enl.Age of oldest child",
               get_coded_string_value(
                           programEnrolment.observations -> '5eabdcce-553b-488f-926c-49849f0c2e98',
                           concepts.map)::TEXT                                                                          as "Enl.Last delivery outcome",
               get_coded_string_value(
                           programEnrolment.observations -> '92475d77-7cdd-4976-98f0-3847939a95d1',
                           concepts.map)::TEXT                                                                          as "Enl.Whether sterilized",
               programEnrolment.observations ->>
               '1b749b48-bfae-470d-8219-a735dae99f7a'::TEXT                                                         as "Enl.Number of male children",
               programEnrolment.observations ->>
               '6679b01b-3f50-4cd9-be85-3cae1a04dabd'::TEXT                                                         as "Enl.Month and year of sterilization",
               ...
               get_coded_string_value(
                           programEncounter.observations -> '2e6b1614-7d6c-4caa-bfbe-e0455c8b2309',
                           concepts.map)::TEXT                                                                          as "Enc.EC program follow up visit by ASHA post monthly assessment",
               get_coded_string_value(
                           programEncounter.observations -> '8e8ad333-4639-45c8-be0a-7bac13d87b98',
                           concepts.map)::TEXT                                                                          as "Enc.Whether lactating mother or irregular periods",
               get_coded_string_value(
                           programEncounter.observations -> '056030f2-944a-4758-ac7c-e62e39935fc5',
                           concepts.map)::TEXT                                                                          as "Enc.Whether missed monthly periods",
               get_coded_string_value(
                           programEncounter.observations -> '6174bf54-6ed6-449e-8263-eb6a46dceb4a',
                           concepts.map)::TEXT                                                                          as "Enc.Whether got monthly periods",
               get_coded_string_value(
                           programEncounter.observations -> '05902834-70dc-4f05-8700-41ac7c7e28c4',
                           concepts.map)::TEXT                                                                          as "Enc.Whether undergone pregnancy test if missed monthly periods",
               get_coded_string_value(
                           programEncounter.observations -> 'ae076480-008d-47ca-9fab-a5300a626e42',
                           concepts.map)::TEXT                                                                          as "Enc.Urine pregnancy test",
               get_coded_string_value(
                           programEncounter.observations -> '6ac76c57-66e4-40e7-b9bb-983f276f986a',
                           concepts.map)::TEXT                                                                          as "Enc.Whether currently pregnant",
               get_coded_string_value(
                           programEncounter.observations -> '66239280-5bb9-437c-86ff-ce9c59f2ea9f',
                           concepts.map)::TEXT                                                                          as "Enc.Whether desire to use any FP methods in future",
               get_coded_string_value(
                           programEncounter.observations -> '0d748e89-f0ce-4891-9f41-a5c3f3c4ba2c',
                           concepts.map)::TEXT                                                                          as "Enc.Whether using any family planning method currently",
               get_coded_string_value(
                           programEncounter.observations -> '518cdd47-a634-4554-ae2d-fcc8e1d8ad14',
                           concepts.map)::TEXT                                                                          as "Enc.Family planning method used currently",
               get_coded_string_value(
                           programEncounter.observations -> '2ccecc3f-7b63-4679-86de-5d7f1c150917',
                           concepts.map)::TEXT                                                                          as "Enc.FP method preference for future use",
               ...
               get_coded_string_value(
                           programEncounter.observations -> 'b9d037fb-50c1-497e-bf5c-4d8419909a31', concepts.map)::TEXT as
                   "Enc.Symptoms of RTI",
               (programEncounter.observations ->> '3f680272-dcfa-4db2-bc02-d4605b5454a2')::TEXT                     as "Enc.Duration of RTI symptom(s) in days",
               get_coded_string_value(
                           programEncounter.observations -> '9947d31c-e70a-4cee-8a7e-63293ce3af9b', concepts.map)::TEXT as
                   "Enc.Whether RTI cured",
               get_coded_string_value(
                           programEncounter.observations -> '3674585b-0ba3-4aeb-8e5a-901ab09ebf37', concepts.map)::TEXT as
                   "Enc.Whether treatment for RTI symptom(s) taken",
               programEncounter.cancel_date_time
                   "EncCancel.cancel_date_time",
               get_coded_string_value(
                           programEncounter.cancel_observations -> '739f9a56-c02c-4f81-927b-69842d78c1e8',
                           concepts.map)::TEXT                                                                      as
